...
- [ ] **Phase 1: Backend Core & OKF Engine** - Setup FastAPI, ADK 2.0, LiteLLM routing, and OKF indexer/matching logic.
...
Plans:
- [ ] 01-01: Establish FastAPI backend, google-adk, and LiteLLM OpenRouter connection wrapper.
- [ ] 01-02: Implement local OKF parser, keyword matching indexer, and context injection middleware.
...
|-------|----------------|--------|-----------|
| 1. Backend Core & OKF Engine | 0/2 | Not started | - |
